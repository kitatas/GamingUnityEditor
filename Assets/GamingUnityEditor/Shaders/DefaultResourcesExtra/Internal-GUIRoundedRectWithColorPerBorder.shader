// Unity built-in shader source. Copyright (c) 2016 Unity Technologies. MIT license (see "Third Party Notices.md")
...
Shader "Hidden/Internal-GUIRoundedRectWithColorPerBorder"
{
    ...
    uniform fixed4 _InternalGUIRoundedRectWithColorPerBorderColor;
    uniform int _ActivateInternalGUIRoundedRectWithColorPerBorder;
    ...
    fixed4 frag (v2f i) : SV_Target
    {
        ...
        // rewriting
        if (_ActivateInternalGUIRoundedRectWithColorPerBorder)
        {
            col *= fixed4(_InternalGUIRoundedRectWithColorPerBorderColor.rgb, 1);
        }
