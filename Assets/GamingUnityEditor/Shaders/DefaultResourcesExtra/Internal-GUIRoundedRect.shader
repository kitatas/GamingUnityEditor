...
Shader "Hidden/Internal-GUIRoundedRect"
{
    ...
    uniform fixed4 _InternalGUIRoundedRectColor;
    uniform int _ActivateInternalGUIRoundedRect;
    ...
    fixed4 frag (v2f i) : SV_Target
    {
        ...
        // rewriting
        fixed4 mul = _ActivateInternalGUIRoundedRect
            ? _InternalGUIRoundedRectColor
            : 1;
        col *= i.color * mul;
