...
Shader "Hidden/Internal-UIRAtlasBlitCopy"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            uniform fixed4 _InternalUIRAtlasBlitCopyColor;
            uniform int _ActivateInternalUIRAtlasBlitCopy;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // rewriting
                fixed4 mul = _ActivateInternalUIRAtlasBlitCopy
                    ? _InternalUIRAtlasBlitCopyColor
                    : 1;
                return color * i.tint * mul;
            }
            ENDCG
        }
    }
